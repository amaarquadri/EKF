...
static constexpr const double LOW_LEVEL_SAMPLE_TIME = 1e-3; //s
static constexpr const double LOCAL_SAMPLE_TIME = 1e-3; //s
static constexpr const double GLOBAL_SAMPLE_TIME = 1e-3; //s